...
function save_options() {
  ...
  var includeActiveTabSetting = html_val_to_bool(
    document.getElementById("includeActiveTab").value
  );
...
function restore_options() {
  chrome.storage.local.get(null, function (items) {
    ...
    document.getElementById("includeActiveTab").value = bool_to_html(
      items.includeActiveTab
    );
